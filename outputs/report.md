...
图2展示了 diary_5 在三条件下的生成结果及 CLIP 分（Baseline=0.2125，Partial=0.2105，Full=0.2387），读者可结合原文自行评判各条件图像的情绪传达：

![图2：diary_5 三条件生成结果对比（含 CLIP Score）](figure_condition_comparison.png)
